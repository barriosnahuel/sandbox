...
// Comienza Declaración de funciones (declaración: cuando solo le avisamos al compilador “che, mira que esto existe. Más abajo te lo defino bien completito papá”)
...
// Comienza Definición de funciones (definición: cuando tiene el bloque de código con el comportamiento)
int main() {
    struct dato vec[TAM];
    int aux, pos;
